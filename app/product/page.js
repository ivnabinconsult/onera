        ...
        <div className="max-w-6xl mx-auto px-8">
          {modules.map((m, i) => (
            <div key={m.title} className={`grid md:grid-cols-2 gap-14 items-center py-14 ${i !== 0 ? "border-t border-line" : ""}`}>
              ...
              <div className={`bg-sky border border-line rounded-2xl p-6 min-h-[220px] ${i % 2 === 1 ? "md:order-1" : ""}`}>
                <div className="flex justify-between mb-4">
                  <div className="h-2.5 bg-[#D8E3F6] rounded w-28"></div>
                  <div className="flex gap-1.5">
                    <span className="w-2 h-2 rounded-full bg-[#C7D5EB]"></span>
                    <span className="w-2 h-2 rounded-full bg-[#C7D5EB]"></span>
                    <span className="w-2 h-2 rounded-full bg-[#C7D5EB]"></span>
                  </div>
                </div>
                <div className="bg-white border border-line rounded-lg p-3.5 mb-3">
                  <div className="h-2 bg-[#D8E3F6] rounded mb-2"></div>
                  <div className="h-2 bg-[#D8E3F6] rounded w-1/2"></div>
                </div>
                <div className="bg-white border border-line rounded-lg p-3.5">
                  <div className="h-2 bg-[#D8E3F6] rounded w-2/3"></div>
                </div>
              </div>
            </div>
          ))}
